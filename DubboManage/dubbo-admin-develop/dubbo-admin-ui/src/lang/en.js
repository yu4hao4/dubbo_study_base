...
export default {
  service: 'Service',
  serviceSearch: 'Search cn.service name',
  ...
  dataIdHint: 'A cn.service ID in form of group/cn.service:version, group and version are optional',
  agree: 'Agree',
  disagree: 'Disagree',
  searchDynamicConfig: 'Search Dynamic Config',
  appNameHint: 'Application name the cn.service belongs to',
  basicInfo: 'BasicInfo',
  metaData: 'MetaData',
  ...
  test: 'Test',
  placeholders: {
    searchService: 'Search by cn.service name'
  },
  methods: 'Methods',
  testModule: {
