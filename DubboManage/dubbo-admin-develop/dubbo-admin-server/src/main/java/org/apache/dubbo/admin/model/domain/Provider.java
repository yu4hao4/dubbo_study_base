...
public class Provider extends Entity {
    ...
    private String service;/* The name of the cn.service provided by the provider */

    private String url; /* Provider's address for cn.service */

    private String parameters; /* Provider provides cn.service parameters */
