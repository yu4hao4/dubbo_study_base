...
public class MetricsServiceImpl implements MetricsService {
    ...
    public RelationDTO getApplicationRelation() {
        ...
        // collect provider's cn.service and applications map <cn.service, set<application>>
