...
//    void halvingProvider(String id);
    ...
    /**
     * Get all provider's cn.service name
     *
     * @return list of all provider's cn.service name
     */
    ...
    /**
     * Get provider list with specific cn.service name.
     *
     * @param serviceName specific cn.service name, cannot be fuzzy string
    ...
    /**
     * Get a set of cn.service data object.
     *
     * ServiceDTO object contains base information include
     * cn.service name , application, group and version.
     *
